workspace extends ../workspace.dsl {
    ...
    model {
        ...
        !include https://raw.githubusercontent.com/wgt-system/illumination/dev/docs/model/model.dsl
    ...
    views {
        ...
        !include https://raw.githubusercontent.com/wgt-system/illumination/dev/docs/model/views.dsl
    }
